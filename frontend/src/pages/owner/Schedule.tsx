...
const Schedule = () => {
  ...
  return (
    <div className="mx-auto min-h-screen max-w-lg bg-white">
      ...
      {/* FAB */}
      {fabOpen && <div className="fixed inset-0 z-[60] bg-black/40" onClick={() => setFabOpen(false)} />}
        ...
        {fabOpen && (
          <>
            <div className="flex items-center gap-3">
              ...
              <button onClick={() => { setFabOpen(false); navigate("/schedule/change-request"); }} className="pressable w-12 h-12 rounded-full flex items-center justify-center" style={{ backgroundColor: '#FFFFFF' }}>
            ...
            <div className="flex items-center gap-3">
              ...
              <button onClick={() => { setFabOpen(false); navigate("/schedule/vacation-request"); }} className="pressable w-12 h-12 rounded-full flex items-center justify-center" style={{ backgroundColor: '#FFFFFF' }}>
                <Palmtree className="h-5 w-5 text-foreground" />
              </button>
            </div>
          </>
        )}
        <button onClick={() => setFabOpen(!fabOpen)} className="pressable w-14 h-14 rounded-full shadow-lg flex items-center justify-center" style={{ backgroundColor: '#4261FF' }}>
