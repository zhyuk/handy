...
const ClosingReport = () => {
  ...
  const handleConfirm = () => {
    ...
    toast({ description: "마감 보고가 완료 되었어요.", duration: 2000 });
    const today = new Date().toISOString().slice(0, 10);
  ...
  const renderInput = (label: string, value: string, onChange: (v: string) => void, placeholder = "숫자만 입력") => (
    <div style={{ marginBottom: '30px' }}>
      <label className="block text-[16px] font-medium" style={{ color: '#70737B', marginBottom: '16px' }}>{label}</label>
      <div className="flex items-center bg-white" style={{ border: '1px solid #DBDCDF', borderRadius: '10px', padding: '0 20px', height: '52px' }}>
        <input
          type="text"
          inputMode="numeric"
  ...
  return (
    <div className="min-h-screen bg-white max-w-lg mx-auto">
      ...
      <div className="flex-1 px-5 pt-4 pb-[100px]">
        ...
        {step === 2 && (
          <>
            ...
            <div className="mb-6" style={{ boxSizing: 'border-box', width: '100%' }}>
              <label className="block text-[16px] font-medium" style={{ color: '#70737B', marginBottom: '16px' }}>현금 과부족</label>
              <div className="flex gap-3" style={{ boxSizing: 'border-box', width: '100%' }}>
                <button
                  onClick={() => setShowCashDiffSheet(true)}
                  className="pressable flex items-center justify-between bg-white flex-shrink-0" style={{ border: '1px solid #DBDCDF', borderRadius: '10px', height: '52px' }}
                ...
                <div className="flex items-center bg-white" style={{ border: '1px solid #DBDCDF', borderRadius: '10px', height: '52px', padding: '0 20px' }} style={{ flex: 1, minWidth: 0, boxSizing: 'border-box' }}>
                  <input
                    type="text"
                    inputMode="numeric"
        ...
        {step === 4 && (
          <>
            ...
            <label className="block text-[16px] font-medium" style={{ color: '#70737B', marginBottom: '16px' }}>추가 전달 내용(선택)</label>
            <button
      ...
      {/* Bottom Button */}
      <div className="fixed bottom-0 left-1/2 -translate-x-1/2 w-full max-w-lg px-5 pb-8 pt-3 bg-white z-40">
        {step < 4 ? (
        ...
        <DrawerContent className="[&>div:first-child]:hidden" style={{ width: '100%', height: '212px', borderRadius: '20px 20px 0 0', backgroundColor: '#FFFFFF', padding: '0' }}>
          <div style={{ paddingLeft: '20px', paddingRight: '20px' }}>
            <div className="flex items-center justify-between" style={{ paddingTop: '30px', paddingBottom: '20px', paddingLeft: '4px' }}>
              ...
              <DrawerClose asChild>
                <button className="pressable" style={{ width: '20px', height: '20px', display: 'flex', alignItems: 'center', justifyContent: 'center', marginRight: '16px' }}>
      ...
      <Drawer open={showMessageSheet} onOpenChange={setShowMessageSheet}>
        <DrawerContent className="[&>div:first-child]:hidden" style={{ width: '100%', borderRadius: '20px 20px 0 0', backgroundColor: '#FFFFFF', padding: '0', paddingBottom: `${keyboardHeight + 32}px` }}>
          <div style={{ paddingLeft: '20px', paddingRight: '20px' }}>
            <div className="flex items-center justify-between" style={{ paddingTop: '30px', paddingBottom: '20px', paddingLeft: '4px' }}>
